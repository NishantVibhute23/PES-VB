...
import com.vollyball.panels.PanTeamPlayerDeails;
...
public class CreateTeamPlayerReportDialog {
    ...
    protected Container createPane() {
        PanTeamPlayerDeails panPlayerDetails = new PanTeamPlayerDeails(prb, skillName, skillId, compId, matchId);
        return panPlayerDetails;
    }

    public void setValues(PlayerReportBean prb, String skillName, int skillId, int compId, int matchId) {
        this.prb = prb;
