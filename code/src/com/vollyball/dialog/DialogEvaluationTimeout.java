...
import com.vollyball.panels.PanEvaluationTimeout;
 ...
 */
public class DialogEvaluationTimeout {
...
//            this.dialog.setSize(418, 505);//
    ...
    protected Container createPane() {
        PanEvaluationTimeout panMatch = new PanEvaluationTimeout(setNum, matchEvaluationTeamId);
